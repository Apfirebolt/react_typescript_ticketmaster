...
const EventDetail: React.FC = () => {
    ...
    return (
        <div>
            <h1 className="bg-secondary-200 text-white text-center py-3 px-2">{event.name}</h1>
            <div className="container mx-auto my-3">
                ...
                {event.images && (
                    <img src={event.images[0]?.url} alt={event.name} style={{ maxWidth: '100%' }} className="mx-auto my-3" />
                )}
