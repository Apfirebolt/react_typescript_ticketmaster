    ...
    <nav className="bg-primary-300 border-gray-200 px-2 sm:px-4 py-4">
                ...
                {user ? (
                  <li>
                    <button
                      ...
                      className="block text-center p-4 dark:text-gray-300 dark:hover:text-gray-100 hover:bg-primary-200 transition-all duration-150"
                    >
                      Logout
                    </button>
                  </li>
                  ...
                  <li>
                    <Link
                      to="/login"
                      className="block text-center p-4 text-white dark:text-gray-300 dark:hover:text-gray-100 hover:bg-primary-200 transition-all duration-150"
                    >
                      Login
                    </Link>
                  </li>
      ...
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        <p className="text-3xl text-white font-bold w-1/3">
          TicketMaster App Hello {user ? user.username : "Guest"}
        </p>
        <button
